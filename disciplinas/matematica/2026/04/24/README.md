...
- [x] Enviar PDF para joao.eichenberger@cps.sp.gov.br

- [x] Elaborar os prompts. Copiar o prompt e a resposta.

- [x] PDF com nomes dos integrantes: nome1_nome2_nome3.docx
